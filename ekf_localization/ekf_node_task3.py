...
class EKF_NODE(Node):
    def __init__(self):
        ...
        self.landmarks_sub = self.create_subscription(LandmarkArray, '/camera/landmarks', self.landmarks_callback, 10)
        ...
        self.landmarks = self.load_landmarks('/home/ubuntu2204/ros2_ws/src/turtlebot3_perception/turtlebot3_perception/config/landmarks1.yaml')
